...
public class followLOVE_131011_pan extends PApplet {
...
public void setup() {
  ...
  /* MONITOR */
  size(PApplet.parseInt(1920*0.73f), PApplet.parseInt(540*0.73f), GLConstants.GLGRAPHICS);
...
class Tweet {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "followLOVE_131011_pan" });
  }
}
