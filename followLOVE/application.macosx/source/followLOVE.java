...
public class followLOVE extends PApplet {
...
//  String connStr = "jdbc:sqlite:" + ("/Users/madscience/Desktop/DROP/basicMap.mbtiles");
  ...
  String connStr = "jdbc:sqlite:" + ("/Users/youjinshin/Documents/TwitterViz/followLOVE/data/basicMap.mbtiles");
...
class Time {
  ...
  public void display() {
    ...
    pushMatrix();
      ...
      fill(0,100);
      noStroke();
      rect(0+width*0.005f,-height*0.042f, width*0.15f, height*0.058f);
...
class Tweet {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "followLOVE" });
  }
}
